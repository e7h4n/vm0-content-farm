...
2. Process each news item sequentially. Complete all steps below for one news item before moving to the next
   1. Download the news article
   2. Read all comments, filtering out off-topic chat comments
   3. Group comments by perspectives/camps, mapping them to several Doraemon characters based on their personalities
